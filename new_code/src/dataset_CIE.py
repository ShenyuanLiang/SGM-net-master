    ...
    def __load_MATLAB(filename):
        ...
        for i in range(G1_num_nodes):
            for j in range(i + 1, G1_num_nodes):
                ...
                # else:
                #     G1_edge_embeddings.append(np.zeros((60,)))
        ...
        for i in range(G2_num_nodes):
            for j in range(i + 1, G2_num_nodes):
                ...
                # else:
                #     G2_edge_embeddings.append(np.zeros((60,)))
        ...
        return permutation_vector, \
               {'num_nodes': G1_num_nodes, 'node_embeddings': G1_node_embeddings, 'num_edges': G1_num_edges,
                'adjacency_list': G1_adjacency_list, 'edge_embeddings': G1_adjacency_matrix_with_embeddings,
                'G_edgeaff': G_edgeaff,
               ...
               {'num_nodes': G2_num_nodes, 'node_embeddings': G2_node_embeddings, 'num_edges': G2_num_edges,
                'adjacency_list': G2_adjacency_list, 'edge_embeddings': G2_adjacency_matrix_with_embeddings,
                'adj': G2_adjacency_matrix}
...
class GMDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        permutation_matrix = np.zeros(
            (pair['G1']['num_nodes'], pair['G2']['num_nodes']),
            np.int32)
